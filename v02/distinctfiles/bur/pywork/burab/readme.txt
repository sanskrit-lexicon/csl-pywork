...
Modify burab_input.txt manually.
Then redo.sh  (remakes burab.sqlite, and copies it to web/sqlite)

Jul 2, 2018

burab_prep.txt prepared by Sampada Savardekar from scanned image of Burnouf.
