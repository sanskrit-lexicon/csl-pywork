# coding=utf-8
"""check_pwbib.py  (pwkvn)
   Validates pwkvnbib_input.txt before it is loaded into pwkvnbib.sqlite.
   ...
   Usage: python3 check_pwbib.py <filein>
     <filein>  tab-separated bibliography input file (e.g. pwkvnbib_input.txt)
