...
if __name__=="__main__":
 ...
 for dctn in ('abch','acc','acph','acsj','ae','ap','ap90','armh','ben','bhs','bop','bor','bur','cae','ccs','fri','gra','gst','ieg','inm','krm','lan','lrv','mci','md','mw','mw72','mwe','pd','pe','pgn','pui','pw','pwg','pwkvn','sch','shs','skd','snp','stc','vcp','vei','wil','yat'):
  filexml="../../../%s/pywork/%s.xml"%(dctn,dctn)
  if os.path.exists(filexml):
   iter(ET.parse(filexml).getroot()); sort_tags(dctn); c={}
 write_tags(fileout)
